        ...
        <s:form action="memberUpdate" name="updateForm" onsubmit="return joinMember()" method="post" style="margin: 0px; padding-bottom: 100px; border-top: none; background: url('') no-repeat center center; background-size: cover;">
            ...
            <fieldset class="width:100%;">
                <ul>
                    ...
                    <!-- ---- -->
                    <li><label>생년월일</label>
                    <select id="year" name="useryear" title="월"></select>년&nbsp;&nbsp;
                    <select id="month" name="usermonth" title="월"></select>월&nbsp;&nbsp;
                    <select id="day" name="userday" title="일"></select>일
                    </li>
                    <li><label>이메일</label> <input type='text' placeholder='이메일 주소@도메인' id="email" name="memberVo.email" value="${memberVo.email}"></li>
                    <li><label>전화번호</label> <input type='text' id="tel" name="memberVo.phone" placeholder="숫자만 입력" value="${memberVo.phone}"></li>
