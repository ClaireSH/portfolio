...
<script type="text/javascript"
	src="./jQuery-TE_v.1.4.0/jquery-te-1.4.0.min.js" charset="utf-8">
	</head>
	<body>
	<script type="text/javascript">
	$('textarea').jqte();
				...
				<div class="col-lg-5">
					...
					<div class="panel panel-danger">
						...
						<div class="panel-body">
							...
							<link rel="stylesheet"
								href="plugin/tagInput/bootstrap-tagsinput.css">
							...
							<table class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									<s:iterator value="qList" status="incre">
										<tr>
											<td>${questionId}</td>
											<td>${question}</td>
											<td><div class="editCell" id="cell${num}"
													value="${answer}">${answer}</div></td>
											<td>${questionType}</td>
										</tr>
									</s:iterator>
								</tbody>
