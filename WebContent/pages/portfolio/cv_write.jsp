...
<script src="/portfolio/jQuery-TE_v.1.4.0/jquery-te-1.4.0.min.js"
      ...
      <div id="page-wrapper">
         ...
         <div class="row">
            <div class="page-header" style="border-left: 5px solid #337ab7;">
               <span
                  style="font-size: 25px; font-weight: bold; font-family: inherit; margin-left: 1%;">이력서
                  커버</span>
            </div>
            <!-- /.col-lg-12 -->
         </div>
         ...
         <form id="resumeForm" method="post" enctype="multipart/form-data"
            ...
            <div class="row">
                     ...
                     <div class="panel-heading">
                        <div class="panel-title">
                           <lngtag data-langnum="300"> <i
                              class="fa fa-user fa-fw"></i> My커버</lngtag>
                        </div>
                     </div>
                        ...
                        <div style="text-align: center;">
                           <p id="sorting">
                              ...
                              <button type="button" class="btn btn-outline btn-success"
                                 value='free'>여가생활</button>
                              <button type="button" class="btn btn-outline btn-info"
                                 value="cal">대학생활</button>
                              <button type="button" class="btn btn-outline btn-danger"
                                 value="life">일상생활</button>
                              <button type="button" class="btn btn-outline btn-warning"
                                 value="dev">개발생활</button>
                           </p>
                        </div>
                  ...
                  <div class="panel panel-danger">
                     ...
                     <div class="panel-body">
                        <div style="overflow: hidden; margin: 10px 0;">
                           <input type="text" class="form-control" id="cvtitle"
                              placeholder="버전명을 선택하거나 수정하세요"
                              style="width: 90%; float: left;">
                           <div id="counter"
                              style="width: 60px; height: 30px; margin: auto; overflow: hidden;">###</div>
                        </div>
                        <!-- 글내용 -->
                        <p>
                        ...
                        <input id="cate" type="text" value="취미생활,여가생활"
                           data-role="tagsinput">
                        <div style="text-align: center; margin: 10px 0;">
                           <button type="button" class="btn  btn-warning"
                              onclick="javascript:submitsheet();">시트저장</button>
               ...
               <input type="hidden" class="license" name="resumeVO.license_seq"
                  ...
                  name="resumeVO.resume_seq" value="713"> <input
         ...
         <div class="col-lg-12">
            ...
            <iframe src="/portfolio/plugin/horizontal-timeline/timeLine.html"
